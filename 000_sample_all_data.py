...
def get_pair_doc_data(y_train, query_id):
    ...
    return samples, tmp_array_train_x0, tmp_array_train_y0, tmp_array_train_x1, tmp_array_train_y1, tmp_array_within_query_signal
...
for k in range(1):
    ...
    trained_model_list = train_model(baseline, actor, critic, 20, model_para['lambda'], beta, gamma)
...
for k in range(1):    
    torch.save(actor_list[k].state_dict(), './tmp_model_saved/sample_0.1_of_all/***_(beta_0.1_gamma_5_epoch_20)_actor_{}.pth'.format(k))
    torch.save(critic_list[k].state_dict(), './tmp_model_saved/sample_0.1_of_all/***_(beta_0.1_gamma_5_epoch_20)_critic_{}.pth'.format(k))
    torch.save(baseline_list[k].state_dict(), './tmp_model_saved/sample_0.1_of_all/***_(beta_0.1_gamma_5_epoch_20)_baseline_{}.pth'.format(k))
