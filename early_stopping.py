...
def train_model(actor_model, critic_model, baseline_model, patience, epoch_start_early_stopping, saved_path, epochs, lamda, beta, gamma):
...
for k in range(1):
    ...
    tmp_saved_path = 'checkpoint.pt'.format(k)
    
    trained_model_list = train_model(actor, critic, baseline, patience, epoch_start_early_stopping, tmp_saved_path, 10000, model_para['lambda'], beta, gamma)
